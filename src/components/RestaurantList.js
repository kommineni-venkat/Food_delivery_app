...
import PreviousOrders from './PreviousOrder' // Corrected import statement
...
const RestaurantList = () => {
  ...
  const filterRestaurants = () => {
    let filtered = [...restaurants]; // Start with a copy of the original restaurants array
  ...
  useEffect(() => {
    filterRestaurants(); // Call filterRestaurants function
